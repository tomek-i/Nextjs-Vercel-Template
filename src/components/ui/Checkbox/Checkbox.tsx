...
// return <div className={twMerge(clsx(CheckboxVariants({ variant, size, className })))} {...props}></div>
...
export const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(
  ({ size = "medium", className, label, indeterminate, ...rest }: CheckboxProps, ref) => {
    ...
    return (
      <div className={twMerge(clsx(checkboxContainerVariants({ size })), className)}>
        <input
          ref={innerRef}
          type="checkbox"
